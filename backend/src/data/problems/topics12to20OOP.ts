...
public class Main {
  ...
  },
  {
    ...
    output_format: 'Three lines showing start, drive, and turbo messages in sequence.',
...
public class Main {
  ...
  },
  {
    ...
    input_format: 'No input needed.',
    output_format: 'Two lines showing constructor output in order of execution.',
...
public class Main {
  ...
  },
  {
    ...
    input_format: 'No input needed.',
    output_format: 'Two lines showing appliance status and fan operation.',
